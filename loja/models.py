...
class Servico(models.Model):
    ...
    # NOVO CAMPO: Quilometragem do veículo no momento do serviço
...
class MovimentacaoEstoque(models.Model):
    ...
    # REMOVIDO: kilometragem e responsavel não pertencem a MovimentacaoEstoque.
    # Eles foram movidos para o modelo Servico.
